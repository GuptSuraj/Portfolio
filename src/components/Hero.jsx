          ...
          >
            ...
            <div className='transition duration-200 delay-100 gap-10 mt-10  ' >
              <div className='flex flex-col justify-center w-[100%] gap-2'>
                <h1 className='text-[#915eff] font-bold text-[30px] text-center'>Looking for Full Time Opportunity</h1>

                <div className='duration-300 delay-75 flex justify-center  mt-5 '>
                  ...
                  <div className='flex justify-center green-pink-gradient rounded-md  z-[100]   w-1/2 h-1/2'>
                    ...
                    <a href='https://drive.google.com/file/d/1Lui_haMwvEuAmAmDdDtSjhaXGQ9Hn7pg/view?usp=sharing' className=' bg-primary hover:bg-tertiary w-full   rounded-md m-[1px]   p-3 font-bold text-center' target="_blank" >My Resume</a>
