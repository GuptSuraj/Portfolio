        ...
        >
          ...
          <div className="text-white ">
            <p className="cursor-pointer " style={textStyle}>
              {/* <span className="text-[40px] font-bold flex absolute top-[.2em]  " style={spanStyle}></span> */}
              <span style={onuStyle} className="flex absolute top-[.5em] left-[2.6em]" >Suraj</span>
